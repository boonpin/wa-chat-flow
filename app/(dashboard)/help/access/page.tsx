    ...
    <PageBody width="content">
      ...
      <div className="space-y-5">
        <Banner tone="info" title="These are administrator tasks">
          Accounts and gateway settings are configured on the server, not in this dashboard. Ask the
          person who maintains your deployment to change them.
        </Banner>
          ...
          <PanelBody>
            <KeyValues
              rows={[
                [
                  'Conversation list',
                  'Inbox shows 25 matching conversations per page with full-record totals; legacy list consumers cap at 100.',
                ],
                [
                  'Conversation transcript',
                  'Shows the most recent 200 messages in a conversation.',
                ],
                [
                  'AI memory',
                  'An AI agent uses up to 20 prior conversation messages and up to 10 pending customer messages.',
                ],
                ['Captures', 'The Captures list shows recent captures, not a lifetime total.'],
                [
                  'Activity',
                  'Paginated recorded messages, agent usage, captures and ownership events within the selected dates; not a comprehensive gateway audit log.',
                ],
                [
                  'Stored credentials',
                  'API keys and sheet credentials are write-only and are never shown again.',
                ],
              ]}
            />
          </PanelBody>
